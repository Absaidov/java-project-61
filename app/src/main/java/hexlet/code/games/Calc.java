...
public class Calc {
    ...
    public static void calcGameStart() {
        ...
        for (int j = 0; j < arrayData.length; j++) {
            int result;
            int randomOperator = generatesRandomNumbers(0, arrayOfOperators.length - 1);
            ...
            result = getExpression(randomNumber1, arrayOfOperators[randomOperator], randomNumber2);
    ...
    private static int getExpression(int number1, String numberForOperator, int number2) {
